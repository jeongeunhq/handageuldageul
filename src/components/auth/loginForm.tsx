...
export default function LoginForm() {
  ...
  return (
    <div className="flex justify-center md:items-center items-start min-h-screen">
      <div className="w-full max-w-[454px] bg-white rounded-xl border-gray-400 px-4 py-6 md:p-8">
